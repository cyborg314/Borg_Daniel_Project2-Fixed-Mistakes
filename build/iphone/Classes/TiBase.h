...
// in simulator we redefine to format for Borg_Daniel_Project2 Developer console
...
{\
	NSString * exceptionName = [@"org.borg_daniel_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.borg_daniel_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBorg_Daniel_Project2NativeItemNone = -1, 
	UIBorg_Daniel_Project2NativeItemSpinner = -2,
	UIBorg_Daniel_Project2NativeItemProgressBar = -3,
	
	UIBorg_Daniel_Project2NativeItemSlider = -4,
	UIBorg_Daniel_Project2NativeItemSwitch = -5,
	UIBorg_Daniel_Project2NativeItemMultiButton = -6,
	UIBorg_Daniel_Project2NativeItemSegmented = -7,
	
	UIBorg_Daniel_Project2NativeItemTextView = -8,
	UIBorg_Daniel_Project2NativeItemTextField = -9,
	UIBorg_Daniel_Project2NativeItemSearchBar = -10,
	
	UIBorg_Daniel_Project2NativeItemPicker = -11,
	UIBorg_Daniel_Project2NativeItemDatePicker = -12,
	
	UIBorg_Daniel_Project2NativeItemInfoLight = -13,
	UIBorg_Daniel_Project2NativeItemInfoDark = -14,
	
	UIBorg_Daniel_Project2NativeItemDisclosure = -15,
	
	UIBorg_Daniel_Project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Borg_Daniel_Project2 instances of
