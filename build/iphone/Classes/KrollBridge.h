...
@interface Borg_Daniel_Project2Object : KrollCoverageObject {
#else
@interface Borg_Daniel_Project2Object : KrollObject {
#endif
@private
...
extern NSString * Borg_Daniel_Project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Borg_Daniel_Project2Object *_borg_daniel_project2;
    KrollObject* console;
	BOOL shutdown;
