...
//@interface Borg_Daniel_Project2Object : NSObject
//@end

@interface Borg_Daniel_Project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Borg_Daniel_Project2Object class]])
		{
			for (NSString *key in [[(Borg_Daniel_Project2Object*)o modules] allKeys])
			{
